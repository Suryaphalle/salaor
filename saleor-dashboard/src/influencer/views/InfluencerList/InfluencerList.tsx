...
interface CustomerListProps {
  params: InfluencerListUrlQueryParams;
}
...
export const CustomerList: React.FC<CustomerListProps> = ({ params }) => {
  ...
  const [openModal, closeModal] = createDialogActionHandlers<
    InfluencerListUrlDialog,
    InfluencerListUrlQueryParams
  >(navigate, influencerListUrl, params);
  ...
  const handleSort = createSortHandler(navigate, influencerListUrl, params);
      ...
      {(bulkRemoveCustomers, bulkRemoveCustomersOpts) => (
        <>
          <CustomerListPage
            ...
            disabled={loading}
            pageInfo={pageInfo}
            onAdd={() => navigate(influencerAddUrl)}
            onNextPage={loadNextPage}
            onPreviousPage={loadPreviousPage}
            onUpdateListSettings={updateListSettings}
            onRowClick={id => () => navigate(influencerUrl(id))}
            onSort={handleSort}
            toolbar={
              <IconButton
                color="primary"
