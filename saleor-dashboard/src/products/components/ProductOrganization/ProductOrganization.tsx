...
interface ProductOrganizationProps {
  ...
  infulencer?: MultiAutocompleteChoiceType[];
  collectionsInputDisplayValue: MultiAutocompleteChoiceType[];
  infulencerInputDisplayValue: MultiAutocompleteChoiceType[];
  ...
  onInfulencerChange: (event: ChangeEvent) => void;
...
const ProductOrganization: React.FC<ProductOrganizationProps> = props => {
  ...
  const formErrors = getFormErrors(
    ["productType", "category", "collections",'infulencer'],
    errors
  );
